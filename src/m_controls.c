...
int key_right = DKEY_RIGHTARROW;
int key_left = DKEY_LEFTARROW;
int key_up = DKEY_UPARROW;
int key_down = DKEY_DOWNARROW; 
int key_strafeleft = DKEY_STRAFE_L;
int key_straferight = DKEY_STRAFE_R;
int key_fire = DKEY_FIRE;
int key_use = DKEY_USE;
int key_strafe = DKEY_RALT;
int key_speed = DKEY_RSHIFT; 

// 
// Heretic keyboard controls
//
 
int key_flyup = DKEY_PGUP;
int key_flydown = DKEY_INS;
int key_flycenter = DKEY_HOME;

int key_lookup = DKEY_PGDN;
int key_lookdown = DKEY_DEL;
int key_lookcenter = DKEY_END;

int key_invleft = '[';
int key_invright = ']';
int key_useartifact = DKEY_ENTER;
...
int key_arti_all             = DKEY_BACKSPACE;
int key_arti_health          = '\\';
...
int key_invpop    = 'z';
int key_invkey    = 'k';
int key_invhome   = DKEY_HOME;
int key_invend    = DKEY_END;
int key_invuse    = DKEY_ENTER;
int key_invdrop   = DKEY_BACKSPACE;
...
int key_message_refresh = DKEY_ENTER;
int key_pause = DKEY_PAUSE;
int key_demo_quit = 'q';
int key_spy = DKEY_F12;
...
int key_map_north     = DKEY_UPARROW;
int key_map_south     = DKEY_DOWNARROW;
int key_map_east      = DKEY_RIGHTARROW;
int key_map_west      = DKEY_LEFTARROW;
int key_map_zoomin    = '=';
int key_map_zoomout   = '-';
int key_map_toggle    = DKEY_TAB;
...
int key_menu_activate  = DKEY_ESCAPE;
int key_menu_up        = DKEY_UPARROW;
int key_menu_down      = DKEY_DOWNARROW;
int key_menu_left      = DKEY_LEFTARROW;
int key_menu_right     = DKEY_RIGHTARROW;
int key_menu_back      = DKEY_BACKSPACE;
int key_menu_forward   = DKEY_ENTER;
int key_menu_confirm   = 'y';
int key_menu_abort     = 'n';

int key_menu_help      = DKEY_F1;
int key_menu_save      = DKEY_F2;
int key_menu_load      = DKEY_F3;
int key_menu_volume    = DKEY_F4;
int key_menu_detail    = DKEY_F5;
int key_menu_qsave     = DKEY_F6;
int key_menu_endgame   = DKEY_F7;
int key_menu_messages  = DKEY_F8;
int key_menu_qload     = DKEY_F9;
int key_menu_quit      = DKEY_F10;
int key_menu_gamma     = DKEY_F11;

int key_menu_incscreen = DKEY_EQUALS;
int key_menu_decscreen = DKEY_MINUS;
...
void M_BindStrifeControls(void)
{
    ...
    key_jump     = 'a';
    key_lookup   = DKEY_PGUP;
    key_lookdown = DKEY_PGDN;
    key_invleft  = DKEY_INS;
    key_invright = DKEY_DEL;
